...
\author {
    ...
    Geguang Pu\textsuperscript{\rm 1}\thanks{Corresponding authors (lijwen2748@gmail.com).} and
...
\begin{itemize}
	\item $\phi|_\mathcal{P} = \phi$ if $\phi$ is $\tt$, $\ff$ or a literal;
	\item $\phi|_\mathcal{P} = \tt$ if $\phi = \ocircle\psi$ or $\phi = \N\psi$;
